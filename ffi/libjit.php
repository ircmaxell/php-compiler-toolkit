...
';
 ...
 // typedefenum jit_abi_t
    const jit_abi_cdecl = 0;
    const jit_abi_vararg = 1;
    const jit_abi_stdcall = 2;
    const jit_abi_fastcall = 3;
 ...
 // typedefenum jit_prot_t
    const JIT_PROT_NONE = 0;
    const JIT_PROT_READ = 1;
    const JIT_PROT_READ_WRITE = 2;
    const JIT_PROT_EXEC_READ = 3;
    const JIT_PROT_EXEC_READ_WRITE = 4;
